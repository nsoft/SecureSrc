...
jar --create --verbose --file securesrc-1.0.0.jar --main-class com.needhamsoftware.securesrc.Main -C distBuild/ .

echo 'Build complete! If you type java -jar securesrc-1.0.0.jar on the command line right now, the application should run'