...
NOTE: I wrote this because I wanted it, not for you. I'm sharing it in the hopes that it will help others. Please read LICENSE.txt before using it. I will try to maintain it from time to time, but am not paid to do so.
...
. run `./gradlew build`
. in the /build/libs directory, you can now run java -jar
