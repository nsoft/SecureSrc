...
We do not build this for you and you should not trust us to do so. Step 1 is to build the software from source code

=== Recommended Way

. Download sourcecode from github releases (Comming Soon)
